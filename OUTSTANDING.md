...
| 9 | **Decide the accessories question** | See *Open questions* below |
...
### 3. Buttons that do not exist yet
...
### 4. Sign-in events are not surfaced
...
### 6. Console demo-data paths still assume every plan has a price
...
### 7. Product photos are still inline base64
...
remove. See the session note for the recommendation.
