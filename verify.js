...
const GATES = [
  ...
  ['audit_tiers.js',      'Plans & tiers    ', 'A plan gates SCALE only — studios, seats, storage — never the production board, Finance or recording a payment, and never progressive disclosure, which must stay free so a studio is not charged at the moment it hires. Going over a limit hides nothing it already has and never blocks editing somebody who is already there; it only stops adding more, and says which plan gives them more and what it costs. The prices must match the operator console, which is what actually bills.'],
